...
const allcolumns = new Map([
    ...
    ['g_below-base', {sql: '[g_below-base].context AS [g_below-base], [g_below-base].text as [g_below-base_sort]', title: 'ligature', searchcolumn: '[g_below-base].text', table: '[g_below-base]', type: 'tamil', render: {_: 'display', sort: 'sort'}, post: (res,c) => {return {display: hyphenateHTMLString(res[c.get('g_below-base')]), sort: res[c.get('g_below-base_sort')]};}}],
    ['g_post-base', {sql: '[g_post-base].context AS [g_post-base], [g_post-base].text as [g_post-base_sort]', title: 'ligature', searchcolumn: '[g_below-base].text', table: '[g_post-base]', type: 'tamil', render: {_: 'display', sort: 'sort'}, post: (res,c) => {return {display: hyphenateHTMLString(res[c.get('g_post-base')]), sort: res[c.get('g_post-base_sort')]};}}],
